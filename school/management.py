...
def add_student(request,pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                message = client.messages.create(
                    to="+233" + student.parent_id.father_phone,
                    from_=TWILIO_PHONE_NUMBER,
                    body="Dear" + " " + student.parent_id.father_name + "," + " " + "the student id of your child is"+" "+ student.id +".Thank you ---- MULAN SMART SCHOOL MANAGEMENT SYSTEM")
                message = client.messages.create(
                    to="+233" + student.parent_id.mother_phone,
                    from_=TWILIO_PHONE_NUMBER,
                    body="Dear" + " " + student.parent_id.mother_name + "," + " " + "the student id of your child is"+" " + student.id + ".Thank you ---- MULAN SMART SCHOOL MANAGEMENT SYSTEM")
            except IOError:
                print('fail')
                pass
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            Revenue.objects.create(
                account_code=acc, amount=st.amount_paid, stubill = st)
            ...
            for p in par:
                try:
                    message = client.messages.create(
                        ...
                        from_=TWILIO_PHONE_NUMBER,
                        body="Dear" + " " + p.father_name + "," + " " + newsms)
                    message = client.messages.create(
